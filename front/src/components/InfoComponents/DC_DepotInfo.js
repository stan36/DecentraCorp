...
<div className="flex-container">
  <Info />
      ...
      The DC Depot:
        ...
        all earn some newely minted IdeaCoin upon a successful purchase. They receive this even if IdeaCoin is not used as a payment method.
      </p>
      <p> Second, IdeaCoin is used to give the DC Depot
        ...
        of PoP Tokens a buyer or seller holds determines how many IdeaCoin they mine when using the DC Depot.
</p>
<p>
         The PoPT is an ERC721 based utility token that
        will give any item the ability to "item mine". Item Mining is a process whereby an Item is digitized into a PoPT. the PoPT is then used like a piggy bank by its owner to store IdeaCoin.
        The Item then encrues interest on this banked IdeaCoin dependant upon the amount stored AND the duration of storage.
        </p>
      </div>
      </div>
    );
