...
<div>
  ...
  <p>
    ...
    replications to others knowing that at the very least they will make an income on the Notio that their
    replication produces (mining replications require a stake in Notio to activate).
  </p>
  <p>
    DecentraCorp provides a new way for entrepreneurs and young inventors to start their own
    facilities both to fund themselves and their research. If done in combination with the DecentraCorp
    outreach program a DecentraCorp facility can be used to facilitate a non profit co-op or even an out-
    right charitable organization.
    </p>
        </div>
        </div>
      </div>
