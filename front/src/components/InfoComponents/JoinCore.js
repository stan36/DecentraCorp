  ...
  render() {
    return(
      <div className='container'>
        ...
        <br/>
        <p>Anyone with React, Python, and or Solidity knowledge is encouraged to apply</p>
        <p>regardless of experience!</p>
        <p>The only requirements for application are an understanding of the projects white papers</p>
        <p>and a willingness to learn</p>
        </div>
    );
  }
}
