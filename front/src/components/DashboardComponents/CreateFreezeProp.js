...
class CreateFreezeProp extends Component {
  constructor(props){
    super(props);
...
goHome = () => {
  ...
  render() {
    ...
    return (
      ...
      <div>
        <h3 className="info">Welcome to The Member Investigation Page!</h3>
        <p className="info">This page allows a DecentraCorp Member to report another Member for abusing the system.
        The information you provide here will be used to determine whether or not a Members Account Should be frozen and Investigated.
        If Found guiolty, a secondary Proposal will be made to Terminate the Member</p>
      ...
      <form onSubmit={this.handleSubmit}>
       ...
       <br/>
         <label htmlFor="Address">Member to be Investigated's Wallet address: </label>
         <br/>
       ...
       <br/>
         <br/>
          <label htmlFor="details">Investigation Request Details: </label>
          <br/>
...
export default CreateFreezeProp;
